...
int main(void){
	int test_array2[] = {6, 2, 5, 1, 8};
	int length2 = sizeof(test_array2) / sizeof(test_array2[0]);
	printf("original: \n");
	print_array(test_array2, length2);
	merge_sort(test_array2, length2);
	printf("sorted: \n");
	print_array(test_array2, length2);
	print_hr();
	...
	merge_sort(test_array1, length1);
	printf("sorted: \n");
	print_array(test_array1, length1);
	print_hr();
}
